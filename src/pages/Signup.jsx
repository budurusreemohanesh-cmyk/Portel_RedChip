...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate API call
    setTimeout(() => {
      const result = signup(formData.name, formData.email, formData.password, formData.college);
      if (result.success) {
      ...
      >
        ...
        <div className="glass-card p-8 border border-white/5 relative overflow-hidden group">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Join the hackathon community</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative group/input">
                <span className="material-icons absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-primary transition-colors text-xl">person</span>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            <div>
              ...
              <div className="relative group/input">
                <span className="material-icons absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-primary transition-colors text-xl">school</span>
                <input
                  type="text"
                  name="college"
            ...
            <div>
              ...
              <div className="relative group/input">
                <span className="material-icons absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-primary transition-colors text-xl">lock_clock</span>
                <input
                  type={showPassword ? 'text' : 'password'}
            ...
            <label className="flex items-start gap-2 cursor-pointer group">
              <input 
                type="checkbox" 
                className="w-4 h-4 mt-0.5 rounded border-white/20 bg-white/5 text-primary focus:ring-primary transition-colors cursor-pointer" 
              />
